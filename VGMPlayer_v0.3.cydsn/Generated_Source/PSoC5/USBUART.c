...
uint8 USBUART_initVar = 0u;
        ...
        {
            0u,
            (uint8) USBUART_ep1_dma_CHANNEL,
            (uint8) USBUART_ep2_dma_CHANNEL,
            (uint8) USBUART_ep3_dma_CHANNEL,
            0u,
            0u,
            0u,
            0u,
    ...
    const uint8 USBUART_DmaBurstEndOut[USBUART_MAX_EP] =
    {
        ...
        {
            0u,
            USBUART_ep1__TD_TERMOUT_EN,
            USBUART_ep2__TD_TERMOUT_EN,
            USBUART_ep3__TD_TERMOUT_EN,
            0u,
            0u,
            0u,
            0u,
