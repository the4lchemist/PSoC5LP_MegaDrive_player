// ======================================================================
// VGMPlayer_v0.4.v generated from TopDesign.cysch
// 11/29/2023 at 17:41
...
module USBFS_v3_20_0 (
	...
	cy_psoc3_pins_v1_10
		#(.id("d3ea0a1c-cc70-47e3-a0c2-0e8584e03c77/8b77a6c4-10a0-4390-971c-672353e2a49c"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("d3ea0a1c-cc70-47e3-a0c2-0e8584e03c77/618a72fc-5ddd-4df5-958f-a3d55102db42"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
